---
title: "GluN2B mutant rescue in *grin2b* knockout: EPSC properties"
output:
...
**test**
```{r}
# Calculate AMPA/NMDA ratios
Data %>%
  mutate(AMPA_NMDA_ratio = peakampa/peaknmda) -> Data
```
...
# Initialize
variates <- c("peaknmda","decaynmda","dt50nmda","chargenmda","peakampa","decayampa","dt50ampa","chargeampa","AMPA_NMDA_ratio")
