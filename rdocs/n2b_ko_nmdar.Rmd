---
title: "*grin2b* knockout: NMDA-EPSC properties"
output:
...
```{r}
Data <- read.delim("../data/n2b_ko_nmdar.dat", header = TRUE)
...
emf(sprintf("../img/%s_%s.emf","n2b_ko_nmdar",resp), width=4, height=3.5)
emm %>%
    as.data.frame() %>%
